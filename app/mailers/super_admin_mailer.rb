class SuperAdminMailer < ApplicationMailer
  ...
  def new_organization_email(organization)
    ...
    mail(to: pluck_super_admin_emails, subject: 'New organization created')
  end
  ...
  def send_statistic_about_new_users_and_organizations
    ...
    mail(to: pluck_super_admin_emails, subject: 'Weekly statistics')
  end

  private

  def pluck_super_admin_emails
